...
namespace redberry
{
    ...
    public class LineNumberStrip : Control
    {
        ...
        private readonly CustomRichTextBox _richTextBox;
        ...
        /// </summary>
        public LineNumberStrip(CustomRichTextBox plainTextBox)
        {
            ...
            this.OffsetColor = Color.White;
            this.Style = LineNumberStyle.OffsetColors;

            _fontBrush = new SolidBrush(Color.FromArgb(120, 152, 180));
        ...
        private void SetFontHeight()
        {
            ...
            this.Font = new Font(_richTextBox.Font.FontFamily, _richTextBox.Font.Size*0.7f, FontStyle.Regular);
        ...
        private void _richTextBox_VScroll(object sender, EventArgs e)
        {
            ...
            if (_richTextBox.Lines.Length > 0 && _speedBump)
            {
